...
<body class="body-pengeluaran">
    <div class="sidebar">
        ...
        <a href="{{ route('data.staf') }}" class="menu-item">
            <div class="icon-circle"><img src="{{ url('images/keperluandashboard/datadata.png') }}"></div>
        ...
        <a href="{{route('produk.admin')}}" class="menu-item">
            <div class="icon-circle"><img src="{{ url('images/keperluandashboard/katalogg.png') }}"></div>
            <div class="menu-text">Katalog Produk</div>
        </a>
        <a href="{{ route('monitoring.admin') }}" class="menu-item">
            <div class="icon-circle"><img src="{{ url('images/keperluandashboard/monitoring.png') }}"></div>
            <div class="menu-text">Monitoring Lahan</div>
        </a>
        <a href="{{ route('transaksi.index') }}" class="menu-item">
            <div class="icon-circle"><img src="{{ url('images/keperluandashboard/transaksi.png') }}"></div>
            <div class="menu-text">Transaksi</div>
        </a>
        <a href="{{ route('pengeluaran.index') }}" class="menu-item active">
            <div class="icon-circle"><img src="{{ url('images/keperluandashboard/pengeluaran.png') }}"></div>
        ...
        <form action="{{ route('logout') }}" method="POST" id="formLogout" class="logout-form">
            ...
            <button type="button" class="menu-item btn-logout" id="btnLogoutTrigger">
                <div class="icon-circle"><img src="{{ url('images/keperluandashboard/logout.png') }}"></div>
    ...
    <div class="main-content">
        ...
        <div class="page-header">
            <div>
                ...
                <p>Kelola dan pantau semua pengeluaran operasional perusahaan.</p>
            </div>
        </div>
                    ...
                    <tbody>
                        @forelse($pengeluarans as $p)
                            <tr>
                                ...
                                <td>
                                    <div class="aksi-container" style="justify-content: center;">
                                        <a href="{{ route('pengeluaran.edit', $p->id_pengeluaran) }}" class="btn-icon" title="Edit Pengeluaran">
